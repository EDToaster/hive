...
describe("GitManager", () => {
  ...
  it("merges a branch into main", async () => {
    ...
    const mergeResult = await git.mergeBranch(result.branch, mainBranch);
