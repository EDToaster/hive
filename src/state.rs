            ...
            if !ops.is_empty() {
                ...
                for op in &ops {
                    s.push_str(&format!(
                        ...
                        op.run_id, op.task_count, op.failed_count, op.agent_count, op.cost_usd
                    ));
...
mod tests {
    ...
    fn make_operation(run_id: &str, task_count: u32) -> OperationalEntry {
        OperationalEntry {
            run_id: run_id.into(),
            task_count,
            failed_count: 0,
